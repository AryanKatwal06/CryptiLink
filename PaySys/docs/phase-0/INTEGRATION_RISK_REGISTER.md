# PaySys - Integration Risk Register
...
Description: Workspace declarations do not match the real folder layout. The root package.json points to `PaymentsApp`, while the PaySys workspace and README describe `apps/*` and `packages/*`, but the actual folders are `mobile/`, `backend/`, and `shared/`.
...
Description: Only health/readiness/liveness endpoints exist. Required PaySys endpoints for auth, wallet, payments, merchant, and user flows are absent.
...
Description: Only two minimal stores exist, and none of the PaySys-required stores (auth, wallet, transaction, offline queue, merchant, UI, notifications) are present.
...
- `PaySys/mobile/package.json`
- `PaySys/mobile/app.json`
- `PaySys/mobile/eas.json`
- `PaySys/mobile/metro.config.js`
- `PaySys/mobile/babel.config.js`
- `PaySys/mobile/screens/Dashboard.tsx`
- `PaySys/mobile/providers/ThemeProvider.tsx`
- `PaySys/mobile/providers/QueryProvider.tsx`
- `PaySys/mobile/providers/StorageProvider.tsx`
- `PaySys/mobile/providers/NotificationProvider.tsx`
- `PaySys/mobile/providers/ErrorBoundary.tsx`
