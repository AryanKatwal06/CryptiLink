# PaySys — Foundation Layer

This folder contains the Phase 0 foundation for the PaySys monorepo. It includes workspace configuration, CI, Docker placeholders, and automation scripts.
