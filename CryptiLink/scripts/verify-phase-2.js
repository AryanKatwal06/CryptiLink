...
const checks = [
  ...
  { name: 'app/index.tsx', ok: fs.existsSync(path.join(mobile, 'app', 'index.tsx')) },
  {
    ...
    ok: fs.existsSync(path.join(mobile, 'app', 'StartupCoordinator.tsx')),
  },
  { name: 'providers', ok: fs.existsSync(path.join(mobile, 'providers')) },
  {
    name: 'navigation/RootNavigator',
    ok: fs.existsSync(path.join(mobile, 'navigation', 'RootNavigator.tsx')),
  },
