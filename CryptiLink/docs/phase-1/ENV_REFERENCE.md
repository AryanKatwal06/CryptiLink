# CryptiLink Environment Reference
...
| RENDER_SERVICE_URL | Render | backend | no | HTTPS URL | `https://cryptilink-api.onrender.com` |
...
| FIREBASE_PROJECT_ID | Firebase | mobile, backend | yes | Firebase project id | `cryptilink` |
...
| ANDROID_KEYSTORE_FILE | Android Build | mobile | yes | Keystore filename | `cryptilink-release.keystore` |
| ANDROID_KEY_ALIAS | Android Build | mobile | yes | Keystore alias | `cryptilink-key` |
