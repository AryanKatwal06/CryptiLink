...
Purpose
- Describe environment variable responsibilities and ownership for PaymentsApp Phase 1.
...
- `SENTRY_DSN`, `POSTHOG_KEY`: owned by DevOps/Platform (secrets stored in infra secret manager)
